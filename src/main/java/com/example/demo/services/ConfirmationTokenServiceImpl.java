...
import static com.example.demo.helpers.enums.AppLinks.CONFIRM_REGISTRATION_LINK;

import com.example.demo.entitety.ConfirmationToken;
import com.example.demo.models.EmailMessage;
import com.example.demo.repos.ConfirmationTokenRepository;
...
public class ConfirmationTokenServiceImpl implements ConfirmationTokenService {
  ...
  public void sendConfirmationEmail(String email, String name, String token) {
    String message = buildHtmlEmail(name,
        CONFIRM_REGISTRATION_LINK.getLink() + token);
